...
import { Container, Button, Typography, Grid, CircularProgress } from "@material-ui/core"
  ...
  return (
    <Container maxWidth="lg">
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={8} sm={6} md={6} lg={6} xl={6} className={classes.searchContainer}></Grid>
        <Grid item xs={4} sm={6} md={6} lg={6} xl={6}>
          {view ? (
            <Button size="large" variant="contained" color="default" onClick={toggle}>
              <RemoveIcon />{" "}
            </Button>
          ) : (
            <Button size="large" variant="contained" color="primary" onClick={toggle}>
              <AddIcon />
            </Button>
          )}
        </Grid>
